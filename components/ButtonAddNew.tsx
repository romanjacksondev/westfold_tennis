...
const ButtonAddNew = ({text, setter, trigger}) => {
  return (
    <>
      <button ref={trigger} onClick={() => setter(true)} className="bg-primary inline-flex items-center justify-center whitespace-nowrap rounded py-[10px] px-5 text-sm font-medium text-white bg-blue-700">
        {text}
        <span className="pl-2">
          <svg
            width="18"
