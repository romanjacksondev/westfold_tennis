...
const classes = {
  ...
  default:
    "block border border-input-border rounded-md py-3 px-3 text-sm leading-3 w-full focus:outline-focus placeholder-placeholder",
};
  ...
  return (
    <div className={clsx(className, "relative")}>
      ...
      <label>
        ...
        <input
          className={clsx(
            disabled && "!border-disabled !text-disabled placeholder-[#AAB4BD]",
            classes[variant],
            inputClassName,
            icon && "pl-[52px]",
            "h-12",
